...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$future_canteen_2022_description = get_bloginfo( 'description', 'display' );
			if ( $future_canteen_2022_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $future_canteen_2022_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
